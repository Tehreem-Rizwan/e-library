...
import 'package:e_library/Config/Messages.dart';
...
class BookController extends GetxController {
  ...
  void getAllBooks() async {
    ...
    for (var book in books.docs) {
      print("Book found: ${book.data()['title']}");
      bookData.add(BookModel.fromJson(book.data()));
    }
    print("Total books fetched: ${bookData.length}");
  }

  void getUserBook() async {
    currentUserBooks.clear();
    print("Fetching user books...");
    var books = await db
        .collection("userBook")
    ...
    print("Fetched ${currentUserBooks.length} books.");
  }
